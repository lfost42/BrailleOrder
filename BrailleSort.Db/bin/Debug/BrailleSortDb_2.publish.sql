...
GO
PRINT N'Creating Table [dbo].[Ascii]...';
...
GO
PRINT N'Creating Table [dbo].[AsciiSymbols]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_AsciiSymbols_Ascii]...';


GO
ALTER TABLE [dbo].[AsciiSymbols]
    ADD CONSTRAINT [FK_AsciiSymbols_Ascii] FOREIGN KEY ([AsciiId]) REFERENCES [dbo].[Ascii] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_AsciiSymbols_Symbols]...';


GO
ALTER TABLE [dbo].[AsciiSymbols]
    ADD CONSTRAINT [FK_AsciiSymbols_Symbols] FOREIGN KEY ([SymbolId]) REFERENCES [dbo].[Symbols] ([Id]);
