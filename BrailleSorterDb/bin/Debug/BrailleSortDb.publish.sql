...
GO
PRINT N'Creating Table [dbo].[Symbol]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Notes_Tickets]...';


GO
ALTER TABLE [dbo].[Notes]
    ADD CONSTRAINT [FK_Notes_Tickets] FOREIGN KEY ([TicketId]) REFERENCES [dbo].[Tickets] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Notes_Users]...';


GO
ALTER TABLE [dbo].[Notes]
    ADD CONSTRAINT [FK_Notes_Users] FOREIGN KEY ([CreatedId]) REFERENCES [dbo].[Users] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Symbols_Symbol]...';


GO
ALTER TABLE [dbo].[Symbols]
    ADD CONSTRAINT [FK_Symbols_Symbol] FOREIGN KEY ([SymbolId]) REFERENCES [dbo].[Symbol] ([Id]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9ef1d06a-0617-4c2e-a9d5-c638340bbfb6')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9ef1d06a-0617-4c2e-a9d5-c638340bbfb6')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '24277cc7-06df-4b1f-b6d4-b996431cfb09')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('24277cc7-06df-4b1f-b6d4-b996431cfb09')
